...
print(True)
print(False) # 자료형, int, float, boolean
...
dic = {'이동건' : '남', "안녕" : '인사', "인사" : '안녕'}
print(dic['인사']) # 자료형 리스트[], 튜플()(수정불가), 딕트{}(키워드-값)

# 형변환

mint = "안녕하세요"
print(type(str(mint)))
print(list(mint)) # myint 를 리스트 형태로 변환하여 출력한다 형변환
...
mstr2='{1} x {0} = {2}'.format(2, 3, 2*3) #포맷팅 중괄호에 순서 값을 넣으면 그 순서 값이 출력된다.
print(mstr2)
...
mstr3="헬로우 안녕하세요"
print(mstr3[2])
print(mstr3[-2]) # 문자열 인덱싱 마이너스는 -1 부터 뒤로 셈

# 문자열 슬라이싱

print(mstr3[4:7]) # 4이상 ~ 7미만
print(mstr3[4:]) # 4이상
print(mstr3[:3]) # 3미만
...
print(lang.split())
l1 = lang.split('어', 3) # 값을 넣지 않으면 공백 기준, 첫번째 파라미터는 자르는 기준, 두번째는 자르는 횟수
print(l1)

# 독스트링
""" 이것도 주석입니다 """ # """로 주석처리, 함수 설명할때 사용

# end, 이스케이프 코드
print('안녕', '헬로우', '잘있어')
print('안녕', end='/') # 넣으면 마지막에 엔터 대신 넣어짐
...
print(mlist1)
mlist1.pop(0)
print(mlist1) # 팝은 프린트에 넣으면 사라지는 인덱스 값이 출력됨, 삽입이랑 추가는 넣으면 none 뜸
mlist1.pop()
print(mlist1)
...
mlist1.sort()
print(mlist1) # 문자 혹은 숫자 한가지 종류로만 이루어진 리스트만 가능
...
n1,n2,n3=mtuple1 # 언패킹
print(n1,n2,n3)

n1, n2 = n2, n1 # 오른쪽 패킹 & 왼쪽 언패킹
print(n1,n2)
